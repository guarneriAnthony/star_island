    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-black mb-5" id="navbarHeader">
            <div class="container-fluid" id="container-fluid">
                <a class="navbar-brand" href="./index.php"><img src="./assets/starisland.png" alt="logo star islande"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item" id="ico-home">
                            <a class="nav-link active" href="./index.php"><img src="./assets/home.png" alt="logo home"></a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="class-div containerItems">
                        <ul class="class-ul">
                            <li class="nav-item item-row firstItem">
                                <img src="./assets/vector.png" class="imgs-nav" alt="logo tutoriel">
                                <a href="https://fivem.net/">
                                    <p class="class-text">Tutoriel</p>
                                </a>
                            </li>
                            <li class="nav-item item-row secondItem">
                                <a href="./event.php"><img src="./assets/vector1.png " class="imgs-nav" alt="logo event"></a>
                                <a href="./event.php">
