...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/star_island/css/style_bootstrap.css" />
    <link rel="stylesheet" href="http://localhost/star_island/css/style_header.css">
</head>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-black mb-5" id="navbarHeader">
            <div class="container-fluid" id="container-fluid">
                <a class="navbar-brand" href="http://localhost/star_island/index.php"><img src="http://localhost/star_island/assets/starisland.png" alt="logo star islande"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item" id="ico-home">
                            <a class="nav-link" href="http://localhost/star_island/index.php"><img src="http://localhost/PHP/star_island/assets/home.png" alt="logo home"></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/star_island/galerie.php">Galerie</a>
                        </li>
                        <li class="nav-item">
