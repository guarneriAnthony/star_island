...
<div class="text-center mx-auto" id="containerVip">
    ...
    <section class="container d-flex" id="contaireText">
        ...
        <div class="align-middle">
            <h3>VIP</h3>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci distinctio inventore maxime officia quae unde veritatis. Accusantium ad autem debitis est explicabo id incidunt iste labore laudantium mollitia, voluptas voluptatibus?
